...
- (void)viewDidLoad {
    ...
    _editImageView = [[ImageEditView alloc] initWithFrame:CGRectMake(0, ([UIDevice lsqIsDeviceiPhoneX] ? -44 : 0), lsqScreenWidth, lsqScreenHeight - ([UIDevice lsqIsDeviceiPhoneX] ? 64 : 44))];
...
// 异步处理图片
- (void)cutWithResult:(TuResult *)result;
{
...
- (void)saveImage:(UIImage *)image {
    ...
    NSString *filePath = [[paths objectAtIndex:0]stringByAppendingPathComponent:
                          [NSString stringWithFormat:@"result_%ld.png", _index]];  // 保存文件的名称
